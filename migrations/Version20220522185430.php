...
final class Version20220522185430 extends AbstractMigration {

    public function up(Schema $schema): void
    {
        $this->addSql('CREATE TABLE foo_message_storage (
    ...
    {
        $this->addSql('DROP TABLE IF EXISTS `foo_message_storage`;');
