...
final class Version20220522185444 extends AbstractMigration {

    public function up(Schema $schema): void
    {
        $this->addSql('CREATE TABLE bar_message_storage (
    ...
    {
        $this->addSql('DROP TABLE IF EXISTS `bar_message_storage`;');
